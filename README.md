...
- **7 Copplings** — mechanical constructs built by Drizzle
...
Single HTML file. No build step. No dependencies beyond Google Fonts. Vanilla CSS and JavaScript. All images embedded as base64. Just open it in a browser.

...
- **13 mission logs** with crew commentary
- **20 journal entries** written from Claude's perspective as the ship's spirit
- **Dynamic Status Board** with live updates from every group on the ship
- **Sub-navigation systems** for content-heavy tabs

## Tech

Single HTML file. No build step. No dependencies beyond Google Fonts. Vanilla CSS and JavaScript. Just open it in a browser.
